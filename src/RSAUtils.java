...
public class RSAUtils {
    ...
    public static String sign(String data, String privateKey) throws Exception {
    	byte[] dataBytes = Base64.decode(URLDecoder.decode(data,"utf-8"));
        byte[] keyBytes = Base64.decode(URLDecoder.decode(privateKey,"utf-8"));
    ...
    public static boolean verify(String data, String publicKey, String sign)
            throws Exception {
    	byte[] dataBytes = Base64.decode(URLDecoder.decode(data,"utf-8"));
        byte[] keyBytes = Base64.decode(URLDecoder.decode(publicKey,"utf-8"));
        ...
        signature.update(dataBytes);
        return signature.verify(Base64.decode(URLDecoder.decode(sign,"utf-8")));
    }
    ...
    public static String decryptByPrivateKey(String encryptedData, String privateKey)
            throws Exception {
    	byte[] dataBytes = Base64.decode(URLDecoder.decode(encryptedData,"utf-8"));
        byte[] keyBytes = Base64.decode(URLDecoder.decode(privateKey,"utf-8"));
        PKCS8EncodedKeySpec pkcs8KeySpec = new PKCS8EncodedKeySpec(keyBytes);
        KeyFactory keyFactory = KeyFactory.getInstance(KEY_ALGORITHM, new org.bouncycastle.jce.provider.BouncyCastleProvider());
     ...
     * 
     * @param data 源数据
     * @param publicKey 公钥(BASE64编码,URLEncoder编码)
     * @return
     * @throws Exception
     */
    public static String encryptByPublicKey(String data, String publicKey)
        ...
        String mString = new String(keyBytes);
        X509EncodedKeySpec x509KeySpec = new X509EncodedKeySpec(keyBytes);
        KeyFactory keyFactory = KeyFactory.getInstance(KEY_ALGORITHM, new org.bouncycastle.jce.provider.BouncyCastleProvider());
        Key publicK = keyFactory.generatePublic(x509KeySpec);
        // 对数据加密
    ...
    public static String getPrivateKey(Map<String, Object> keyMap)
        ...
        return URLEncoder.encode(Base64.encode(key.getEncoded()),"utf-8");
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("签名文字：" + source);
        encodedData = RSAUtils.encryptByPrivateKey(source, privateKey);
